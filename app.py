...
with st.sidebar:
    ...
    **Course:** CL653 — AI/ML for Chemical Eng.
    """)
    run_button = st.button("🚀 Run Full Analysis", width=True, type='primary')
...
with tab1:
    ...
    st.pyplot(fig, width=True); plt.close()
    ...
    st.dataframe(cov_df, width=True, height=300)
